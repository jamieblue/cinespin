...
- The homepage does however use Tanstack query as the random backdrop film will be one of a much smaller list of films which does not often see additions, meaning the same one can often appear again, these films are easily cached because of this. 
